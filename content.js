// Content model for the Say-Do Gap Self-Assessment
// Categories are keyed A-F to match the facilitator brief. Labels are what participants see.

const CATEGORIES = {
  A: { key: "A", label: "Direction & Empowerment" },
  B: { key: "B", label: "Innovation & Experimentation" },
  C: { key: "C", label: "Customer & Data Centricity" },
  D: { key: "D", label: "Workload & Sustainability" },
  E: { key: "E", label: "Culture & Feedback" },
  F: { key: "F", label: "GenAI Adoption" },
};

// Screen 2 - SAY (multi-select, not scored, not used for logic)
const SAY_STATEMENTS = [
...
// Screen 3 - DO (ranking, drives logic). Each item maps to a category key.
const DO_ITEMS = [
...
// Private result screens. {{secondary}} is replaced with the label of the participant's
// #2-ranked category at render time.
const RESULTS = {
  A: {
...
module.exports = { CATEGORIES, SAY_STATEMENTS, DO_ITEMS, RESULTS };
